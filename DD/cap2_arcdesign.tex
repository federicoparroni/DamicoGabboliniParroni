...
\begin{figure}[H]
\begin{center}
\includegraphics[width=\textwidth, keepaspectratio, angle=90,origin=c]{"image/RuntimeViews/RecoverCredentialsRuntimeView2".png}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=\textwidth, keepaspectratio, angle=90,origin=c]{"image/RuntimeViews/BookingPhaseRuntimeView".png}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=\textwidth, keepaspectratio, angle=90,origin=c]{"image/RuntimeViews/NotifySharedMeansRuntimeView".png}
