...
\item The system should offer the possibility to create a new account that the owner can use for authentication \label{goal:G3}

\item The system S.B.A to book the travel means involved in the current schedule under user approval \label{goal:G5} 

\item The system S.B.A to display the result of the scheduling 
\label{goal:G6}

\item the system should offer a GUI that handles All the interactions with the user. \label{goal:G7}
 
operation through a graphical interface
%comprare biglietti
