...
\item The system S.P.W. to create a valid schedule of the user appointments \textbf{when requested}(fare ref alla def) \label{goal:G2}
...
\item The system S.B.A. to display the current position of the user and give travel indication in real time to this one when requested (tipo GPS) \label{G7}
