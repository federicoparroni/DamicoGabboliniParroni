...
%input{cap3_struttura_del_progetto}
%\input{cap4_calibrazione_della_videocamera}
%\input{cap5_riconoscimento}
%\input{cap6_localizzazione}
%\input{cap7_inseguitore}
%\input{cap8_test}
%\input{cap9_conclusioni}
%...
