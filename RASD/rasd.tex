...
\lstset{frame=tb,
  language=Java,
  morekeywords={module, open, integer, ordering, as, sig, one, some, set, not, in, all, no, none, and, or, fact, pred, fun, implies, sum, check, run, but},
  aboveskip=3mm,
  belowskip=3mm,
...
%%CAPITOLI===============================================
\input{cap1_introduzione}
\input{cap2_overalldesc}
\input{cap3_specificreq}
\input{cap4_alloy}
\input{cap5_effort}
\input{cap6_references}
