...
%\item The system S.B.A. to retrive from an external API the Graphical representation of the path that will be travelled by the user

Requirements for \goalref{goal:g99}:
...
Requirements for \goalref{goal:G100}
...
\item Shared travel means can be booked for the next 15 minutes;
