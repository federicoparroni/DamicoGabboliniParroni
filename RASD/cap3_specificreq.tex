...
\textbf{Actors:} User \\ \hline
\textbf{Goals:} (\textbf{goal che l'utente può creare un appointment})\\ \hline
\textbf{Input Condition: The user is registered to the system} \\ \hline
\textbf{Event Flow:}
\begin{enumerate}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=400pt, keepaspectratio]{"images/seqDiagramAppointmentCreation".png}
