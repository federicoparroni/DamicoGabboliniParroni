...
\begin{figure}[H]
\begin{center}
\includegraphics[width=180pt, keepaspectratio]{"images/#1".png}
\caption{#2}
\end{center}
\end{figure}
}
...
\input{cap2_functionalities}
\input{cap3_frameworks}
\input{cap4_servercodestructure}
\input{cap5_clientcodestructure}
\input{cap6_testing}
\input{cap7_installation}
\input{cap8_effort}
